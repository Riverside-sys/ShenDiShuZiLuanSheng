    ...
    for (let i = 0; i < arrData.length; i++) {
        ...
        if (item.data) {
            arrData.some((item1) => {
              ...
              <div class="firetcItem"><div>测点名称：</div> <div class="rightItemText">${
                  item1.data.pointCode ? item1.data.pointCode : ""
              }</div></div>
              <div class="firetcItem"><div>检测值：  </div> <div style="color:#FEC21F">${
                  item1.data.rtValue ? item1.data.rtValue : 0
              }</div> </div>
              <div class="firetcItem"><div>更新时间：</div> <div class="rightItemText">${
                  item1.data.csDataTime ? item1.data.csDataTime : ""
              }</div></div>
              </div>`,
                        },
                        isclose: true,
    ...
    for (let i = 0; i < arrData.length; i++) {
        ...
        if (item.data) {
            arrData.some((item1) => {
              ...
              <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>测点位置：</div> <div class="rightItemText">${
                  item1.name ? item1.name : ""
              }</div> </div>
              <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>监测值：</div> <div class="rightItemText" style="color:rgba(255, 190, 50, 1)">${
                  item1.data.rtValue ? item1.data.rtValue : ""
              } m³/h</div> </div>
              <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>测点名称：</div> <div class="rightItemText">${
                  item1.name ? item1.name : ""
              }</div> </div>
              <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>更新时间：</div> <div class="rightItemText">${
                  item1.data.csDataTime ? item1.data.csDataTime : ""
              }</div> </div>
               </div>
                  `,
            ...
            arrData.some((item1) => {
                popups.add({
                    ...
                    content: {
                        ...
                        content: `<div class="gastcBox" style="height:213px">
          <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>测点位置：</div> <div class="rightItemText">${
              item1.data.pointAreaName ? item1.data.pointAreaName : ""
          }</div> </div>
          <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>监测值：</div> <div class="rightItemText" style="color:rgba(255, 190, 50, 1)">${
              item1.data.crValue ? item1.data.crValue : ""
          }</div> </div>
          <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>测点名称：</div> <div class="rightItemText">${
              item1.name ? item1.name : ""
          }</div> </div>
...
export const peopleDiv = (arrData) => {
    for (let i = 0; i < arrData.length; i++) {
        ...
        if (item.data) {
                ...
                if (item1.data.psPersonName || item1.data.title) {
                    popups.add({
                        ...
                        content: {
                            ...
                            content: `<div class="gastcBox" style="height:213px">
            <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>人员名称：</div> <div class="rightItemText">${
                item1.data.psPersonName ? item1.data.psPersonName : ""
            }</div> </div>
            <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>人员编码：</div> <div class="rightItemText">${
                item1.data.psPersonCard ? item1.data.psPersonCard : ""
            }</div> </div>
            ...
            <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>人联系方式：</div> <div class="rightItemText">${
                item1.data.psPersonPhone ? item1.data.psPersonPhone : ""
            }</div> </div>
                          </div>
                            `,
                        },
            ...
            arrData.some((item1) => {
                popups.add({
                    ...
                    content: {
                        header: `${item1.name}`,
                        content: `<div class="gastcBox" style="height:213px">
          <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>基站位置：</div> <div class="rightItemText">${
              item1.data.psStationLocation ? item1.data.psStationLocation : ""
          }</div> </div>
          <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>基站名称：</div> <div class="rightItemText">${
              item1.data.psStationName ? item1.data.psStationName : ""
          }</div> </div>
          <div class="firetcItem2" style="border-bottom:1px solid #45AEFF"><div>基站编码：</div> <div class="rightItemText">${
              item1.data.psStationCode ? item1.data.psStationCode : ""
          }</div> </div>
                        </div>
                          `,
                    },
            ...
            arrData.some((item1) => {
                popups.add({
                    ...
                    content: {
                        ...
                        //
                        content: `<div class="gastcBox" style="height:213px">
          <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>摄像头名称：</div> <div class="rightItemText">${
              item1.data.monitorName ? item1.data.monitorName : ""
          }</div> </div>
          <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>摄像头地址：</div> <div class="rightItemText">${
              item1.data.monitorName ? item1.data.monitorName : ""
          }</div> </div>
          <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>摄像头型号：</div> <div class="rightItemText">${
              item1.data.monitorModel ? item1.data.monitorModel : ""
          }</div> </div>
           <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>更新时间：</div> <div class="rightItemText">${
               item1.data.updateTime ? item1.data.updateTime : ""
           }</div> </div>
                        </div>
                          `,
                    },
            ...
            arrData.some((item1) => {
                popups.add({
                    ...
                    content: {
                        ...
                        content: `<div class="gastcBox" style="height:213px">
            <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>测点名称：</div> <div class="rightItemText">${
                item1.data.sensorLocationStr ? item1.data.sensorLocationStr : ""
            }</div> </div>
            <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>测点位置：</div> <div class="rightItemText">${
                item1.name ? item1.name : ""
            }</div> </div>
            <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>实时值：</div> <div class="rightItemText" style="color:rgba(255, 190, 50, 1)">${
                item1.data.pointValue ? item1.data.pointValue : ""
            }MPa</div> </div>
            <div class="firetcItem" style="border-bottom:1px solid #45AEFF"><div>记录时间：</div> <div class="rightItemText">${
                item1.data.dateTime ? item1.data.dateTime : ""
            }</div> </div>
                          </div>
                            `,
                    },
