...
export const saltCaveModelUrl = saltCaveModelAssetUrl;
export const saltCaveMultipleUrl = saltCaveMultipleAssetUrl;
export const saltCaveSingleUrl = saltCaveSingleAssetUrl;
export const smoothClosedCaveUrl = smoothClosedCaveAssetUrl;
